...
流程（见方案§4、§5）：
校方输入月度反诈主题 -> AI 校验并生成「基础必修 + 兴趣选修 + 成果任务」任务包草稿
...
def _build_draft(theme: Theme) -> dict[str, Any]:
    ...
    items: list[dict[str, Any]] = [
        # 基础必修
        {
            ...
            "category": "required",
            "title": "主题导入微课",
            "description": f"了解「{title}」的基本套路、高发人群与资金陷阱。",
        ...
        },
        {
            ...
            "category": "required",
            "title": "基础知识答题",
            "description": "完成基础选择题/判断题，检验核心风险点掌握情况。",
            "resourceHint": "题库自动组卷",
        ...
        },
        {
            ...
            "category": "required",
            "title": "风险信号识别",
            "description": "从真实案例中标注垫付、返佣、连续转账等高危信号。",
            "resourceHint": "案例材料",
            "acceptanceCriteria": "标出规定数量的高危风险信号",
            "estimatedMinutes": 15,
            "energyReward": 20,
            "dueDay": 3,
        },
        {
            ...
            "category": "required",
            "title": "主题复盘",
            "description": "填写「我最容易忽略的三个风险点」，形成自我提醒。",
            "resourceHint": "复盘模板",
            "acceptanceCriteria": "提交不少于 3 条风险点复盘",
            "estimatedMinutes": 10,
            "energyReward": 15,
            "dueDay": 5,
        },
        {
            ...
            "category": "outcome",
            "title": "基础成果创作",
            "description": f"制作一项可传播的防诈成果：{theme.expected_outcome or '反诈提示卡或海报'}。",
        ...
        },
        {
            ...
            "category": "elective",
            "title": "诈骗话术找茬",
            "description": "从聊天记录中找出高危信号。",
            "resourceHint": "话术样本",
            "acceptanceCriteria": "找出规定数量的高危信号",
            "estimatedMinutes": 10,
            "energyReward": 20,
            "dueDay": 4,
        },
...
def confirm_theme(db: Session, theme_id: str, edits: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    plan = LearningPlan(
        ...
        summary=theme.description or "本月反诈主题任务包（校方发布）",
        source="school-theme",
        status="published",
    )
    db.add(plan)

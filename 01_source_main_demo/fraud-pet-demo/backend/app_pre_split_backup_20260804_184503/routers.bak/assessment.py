...
v0：传统一次性测评（/api/assessment/*）。
v1：基于 AssessmentSession 的会话式测评与五维能力画像（/api/v1/assessment/*）。
"""
...
from ..assessment_service import (
    MODE_CONFIG,
    create_session as create_assessment_session,
    finalize_session as finalize_assessment_session,
    record_answer as record_assessment_answer,
)
from ..database import get_db
from ..models import (
    AbilitySnapshot,
    AssessmentAnswer as AssessmentAnswerRecord,
    AssessmentResult,
    AssessmentSession,
    QuestionMetadata,
)
...
router_v1 = APIRouter(prefix="/api/v1/assessment", tags=["assessment-v1"])
...
@router_v1.post("/sessions/answer")
...
@router_v1.post("/sessions/complete")
